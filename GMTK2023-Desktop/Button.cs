...
namespace GMTK2023_Desktop
{
    internal class Button : Entity
    {
        ...
        public Button(GMTK2023Game game, Vector2 position, Sprite sprite, GameTime gameTime, Action clickFunc, SpriteFont font = null, string text = null, Rectangle? boundaries = null) : base(game, position, sprite, gameTime)
        {
